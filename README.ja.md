...
> [!IMPORTANT]
> 現在のリリースは **v0.4.0**、公開日は **2026年5月25日**。tmux 互換の 90 コマンドはすべて実装済みですが、まだ新しい公開プレビューのため不具合が残る可能性があります。問題は [issues](https://github.com/helvesec/rmux/issues) へ報告できます。
...
直接ダウンロードと SHA256 チェックサムは [v0.4.0 GitHub Release](https://github.com/helvesec/rmux/releases/tag/v0.4.0) で確認できます。
